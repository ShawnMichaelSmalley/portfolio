...
if (jQuery('#map-spowell').length) {

	var pos = new google.maps.LatLng(35.4936127, -97.5210255);

	var map = new google.maps.Map(document.getElementById('map-spowell'), {
		zoom : 15,
		center : pos,
		scrollwheel: false,
		mapTypeId : google.maps.MapTypeId.ROADMAP
	...
	var pos_New2 = new google.maps.LatLng(35.4936127, -97.5210255);
...
jQuery(window).load(function() {
	...
	if (jQuery('.sport-widget-wrap,.social-widget-wrap').length) {
		$('.sport-widget-wrap,.social-widget-wrap').flexslider({
			animation : "slide",
			directionNav : true,
			controlNav : false,
			start : function(slider) {
