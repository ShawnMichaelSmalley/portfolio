...
// ##### S.Powell Twitter Widget #####
// Custom version to populate widget on homepage using HTML wrappers

var config8 = {
  "id": '880523927516303361',
  "dataOnly": true,
  "customCallback": populateTpl
};
...
function populateTpl(tweets){
  var element = document.getElementById('spowell-twitter');
  var html = '<ul class="slides">';
  for (var i = 0, lgth = tweets.length; i < lgth ; i++) {
    var tweetObject = tweets[i];
    html += '<li>'
+ '<article class="sliding-social-widget row">'
+ '<div class="col-sm-2 twitter-logo">'
+ '<a href="' + tweetObject.permalinkURL + '" target="_blank">'
+ '<i class="fa fa-twitter"></i>'
+ '</a>'
+ '</div>'
+ '<div class="col-sm-10">'
+ '<blockquote>'
+ '<a href="' + tweetObject.permalinkURL + '" class="twitter-username"> ' + tweetObject.author + ' </a> ' + tweetObject.tweet
+ '<span class="time-ago"> ' + tweetObject.time + ' </span>'
+ '</blockquote>'
+ '</div>'
+ '</article>'
+ '</li>';
